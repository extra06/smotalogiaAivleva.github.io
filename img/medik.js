const serviceData = [
  ...
  },
  {
    ...
    lead: "Лечение дёсен, профессиональная гигиена, отбеливание и шинирование.",
    items: [
      ["Компьютерная рентген-диагностика", "550 руб."],
      ["Анестезия", "550 руб."],
      ...
      ["Лазерное отбеливание, 2 челюсти", "18 000 руб."],
      ["Лазерное отбеливание, 1 челюсть", "9 000 руб."]
    ]
  },
  {
    ...
    items: [
      ...
      ["Удаление зуба сложное, с разделением корней", "2 800 руб."],
      ...
      ["Установка импланта Osstem TS 3 SA", "35 000 руб."],
      ["Установка импланта Osstem TS 3 CA, в растворе кальция", "35 000 руб."],
      ["Установка импланта Straumann SLA", "45 000 руб."],
      ["Установка формирователя десны", "2 500 руб."],
      ["Установка импланта Straumann SLActive", "48 000 руб."],
      ["Вскрытие импланта, установка формирователя десны без стоимости формирователя", "1 200 руб."],
      ...
      ["Установка формирователя десны на имплантат", "2 000 руб."]
    ]
  },
  {
    title: "Ортопедия",
    tag: "Коронки, виниры, протезы",
    lead: "Коронки, протезирование, виниры, абатменты и конструкции на имплантах.",
    items: [
      ...
      ["Винир керамический E-max", "19 700 руб."],
...
const servicePageConfigs = [
  ...
  },
  {
    ...
    title: "Пародонтология",
    label: "Десны, гигиена и отбеливание",
    url: "periodontology.html",
    doctor: {
      name: "Кузьменко Татьяна Александровна",
      url: "doctor-kuzmenko.html"
    },
    description: "Лечение десен, профессиональная гигиена, шинирование и лазерное отбеливание в одной странице направления.",
    menuDescription: "Комплексный уход за деснами, гигиена полости рта, лазерные методики и эстетические процедуры.",
    priceGroups: [
      {
        id: "diagnostics",
      ...
      },
      {
        id: "whitening",
        label: "Отбеливание",
        description: "Лазерные эстетические процедуры по осветлению улыбки.",
        patterns: [/отбелив/i]
      },
      {
        id: "splinting",
  ...
  },
  {
    ...
    label: "Коронки, виниры и конструкции на имплантах",
    url: "orthopedics.html",
    doctor: {
      name: "Ивлев Андрей Михайлович",
      url: "doctor-ivlev.html"
    },
    description: "Коронки, виниры, съемные и несъемные конструкции, а также протезирование на имплантах.",
    ...
    priceGroups: [
      ...
      {
        id: "crowns",
        label: "Коронки, виниры и вкладки",
        description: "Несъемные эстетические и функциональные конструкции.",
        patterns: [/Коронка|Винир|E-max|циркони|Безметалловая|Вкладка культевая|Зуб литой/i]
      },
      {
        id: "removable",
...
const serviceCardConfigs = [
  {
    id: "therapy",
    title: "Лечение зубов",
    description: "Кариес, каналы, реставрации.",
    url: "therapy.html",
  ...
  },
  {
    id: "periodontology",
    title: "Пародонтология",
    description: "Десны, гигиена, поддержка тканей.",
    url: "periodontology.html",
  ...
  },
  {
    id: "implantation",
    title: "Имплантация",
    description: "Импланты и подготовка объема.",
  ...
  },
  {
    ...
    description: "Коронки, виниры, конструкции.",
    url: "orthopedics.html",
  ...
  },
  {
    id: "whitening",
    title: "Отбеливание",
    description: "Лазерное осветление улыбки.",
    url: "periodontology.html#periodontology-whitening",
    priceSource: { slug: "periodontology", group: "whitening" }
  }
];
